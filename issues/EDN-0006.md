...
## Acceptance Criteria
- `ctest -R edn.phase4.full` passes without assertion (with assertions enabled and debug info on/off).
- Added regression test ensures ABI golden test remains green.
- Root cause documented (specific failing cast site and why type mismatch occurred).
