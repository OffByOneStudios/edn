...
int main(){
    ...
    std::cout << "[dbg] after run_phase4_eh_disabled_no_invoke_test" << std::endl;
    auto s = to_string(m);
    assert(s.find("{") == 0);
    ...
    std::cout << "[dbg] after run_phase4_eh_panic_negative_test" << std::endl;
    run_phase4_eh_personality_test();
    std::cout << "[dbg] after run_phase4_eh_personality_test" << std::endl;
    run_phase4_target_triple_test();
    std::cout << "[dbg] after run_phase4_target_triple_test" << std::endl;
    run_phase4_eh_invoke_smoke_test();
    std::cout << "[dbg] after run_phase4_eh_invoke_smoke_test" << std::endl;
    run_phase4_eh_seh_invoke_smoke_test();
    std::cout << "[dbg] after run_phase4_eh_seh_invoke_smoke_test" << std::endl;
    run_phase4_eh_panic_unwind_test();
    std::cout << "[dbg] after run_phase4_eh_panic_unwind_test" << std::endl;
    run_phase4_eh_panic_unwind_seh_test();
    std::cout << "[dbg] after run_phase4_eh_panic_unwind_seh_test" << std::endl;
    run_phase4_eh_seh_cleanup_consolidation_test();
    std::cout << "[dbg] after run_phase4_eh_seh_cleanup_consolidation_test" << std::endl;
    run_phase4_passes_mem2reg_test();
    std::cout << "[dbg] after run_phase4_passes_mem2reg_test" << std::endl;
    run_phase4_passes_dce_test();
    std::cout << "[dbg] after run_phase4_passes_dce_test" << std::endl;
    run_phase4_eh_itanium_try_catch_smoke_test();
    std::cout << "[dbg] after run_phase4_eh_itanium_try_catch_smoke_test" << std::endl;
    run_phase4_eh_panic_inside_try_itanium_test();
    std::cout << "[dbg] after run_phase4_eh_panic_inside_try_itanium_test" << std::endl;
    run_phase4_eh_panic_inside_try_seh_test();
    std::cout << "[dbg] after run_phase4_eh_panic_inside_try_seh_test" << std::endl;
    run_phase4_coro_ir_golden_test();
    std::cout << "[dbg] after run_phase4_coro_ir_golden_test" << std::endl;
    run_phase4_coro_lowering_smoke_test();
    std::cout << "[dbg] after run_phase4_coro_lowering_smoke_test" << std::endl;
