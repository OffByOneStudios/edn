...
int main(){
    const char* src = R"((module :id "match_tuple_over_arity_neg"
    ...
    if(!saw){ std::cerr << "[match-tuple-over-arity-neg] expected E1454 not found\n"; return 1; }
    std::cout << "[match-tuple-over-arity-neg] ok\n"; return 0; }
