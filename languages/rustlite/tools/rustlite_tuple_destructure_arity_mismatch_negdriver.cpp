// Negative driver: tuple pattern arity mismatch -> E1454
#include <iostream>
#include "edn/edn.hpp"
#include "rustlite/expand.hpp"
int main(){
    const char* src = R"((module :id "tuple_pattern_arity_neg"
    ...
    if(!saw){ std::cerr << "[tuple-destructure-arity-neg] expected E1454 not found\n"; return 1; }
    std::cout << "[tuple-destructure-arity-neg] ok\n"; return 0; }
